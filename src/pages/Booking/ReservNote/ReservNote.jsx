...
class ReservNote extends Component {
  ...
  render() {
    ...
    if (this.state.pageSelection === "General") {
      content = <General id="General" checked={this.state.General} delegate={this.checkboxClicked} />;
    } else if (this.state.pageSelection === "Refund") {
      content = <Refund id="Refund" checked={this.state.Refund} delegate={this.checkboxClicked} />;
    } else if (this.state.pageSelection === "Payment") {
      content = <Payment id="Payment" checked={this.state.Payment} delegate={this.checkboxClicked} />;
    } else {
      content = <Luggage id="Luggage" checked={this.state.Luggage} delegate={this.checkboxClicked} />;
    }
    ...
    return (
      <div className="ReservNote">
        ...
        <div className="list">
          <div
            className={"General " + (this.state.pageSelection === "General" ? "selected" : "")}
            id="General"
            onClick={this.handleInput}>
            일반규정
          </div>
          <div
            className={"Refund " + (this.state.pageSelection === "Refund" ? "selected" : "")}
            id="Refund"
            onClick={this.handleInput}>
            예약/환불 규정
          </div>
          <div
            className={"Payment " + (this.state.pageSelection === "Payment" ? "selected" : "")}
            id="Payment"
            onClick={this.handleInput}>
            결제규정
          </div>
