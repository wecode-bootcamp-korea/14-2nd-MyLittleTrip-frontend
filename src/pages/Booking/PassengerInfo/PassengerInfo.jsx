...
class PassengerInfo extends Component {
  ...
  changeColor(){
    this.setState({genderSelection: !this.state.genderSelection})
  }
    ...
    <div className='PassengerInfo'>
      ...
      <div className='InfoContainer'>
        ...
        <div className='NameContainer'>
          ...
          <p>예약 후 변경이 불가능하오니 신분증과 동일한 성함 기재 부탁드립니다.</p>
        ...
        <div className='passengerGenderContainer'>
          ...
          <div className='pickGender'>
            <span className='maleCover'>
              <button className={'maleButton ' + (this.state.genderSelection === 'maleButton'? 'selected': '')}>남성</button>
            </span>
            <span className='femaleCover'>
              <button className='femaleButton'>여성</button>
            </span>
          </div>
        </div>
        ...
        <div className='depaturePaymentContainer'>
          <div className='payment'>
            ...
            <select>
              <option disabled='disabled'>※ 단, 할인 및 특가 운임의 경우 운임할인이 적용되지 않습니다.</option>
              <option value='ADT'>성인()</option>
            </select>
            <p>※ 신분할인 적용 시 할인율은 조건에 따라 상이하며,
            할인반영 금액은 결제완료 후 확인 가능합니다.</p>
          </div>
        </div>
